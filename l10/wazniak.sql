...
--
-- Host: 127.0.0.1
-- Czas generowania: 16 Lut 2023, 20:58
...
ALTER TABLE `pracownicy`
  ...
  ADD CONSTRAINT `fk_szef` FOREIGN KEY (`ID_SZEFA`) REFERENCES `pracownicy` (`ID_PRAC`),
  ADD CONSTRAINT `fk_zesp` FOREIGN KEY (`ID_ZESP`) REFERENCES `zespoly` (`ID_ZESP`);
COMMIT;
